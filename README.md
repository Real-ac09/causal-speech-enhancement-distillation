...
2. [Results chapter](docs/thesis/results_chapter_draft.md)
3. [Model-version and architecture handover](docs/thesis/model_version.md)
4. [Figure provenance and evidence policy](docs/figures/thesis/README.md)
