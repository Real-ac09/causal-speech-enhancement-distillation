...
ROOT_OUT="results/v51_optimizer_recovery/v51_recovery_main/magnitude_ablation"
...
exec 9>logs/v51_optimizer_recovery/magnitude_ablation.lock
flock -n 9 || { echo "Another V5.1 magnitude ablation is active" >&2; exit 1; }

candidate_args=()
for scale in 0.25 0.50 0.625 0.75 0.875 1.00; do
...
echo "Magnitude ablation complete: $ROOT_OUT/comparison/comparison.json"
